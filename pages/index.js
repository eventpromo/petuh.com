  ...
  return (
    <Layout>
      ...
      <main className="w-full">
        ...
        <ul className="w-full">
          <div>
            Одной темной ночью на прошедших выходных зародилась новая религия - петушарианство. Как известно, главный петушара - Серега, он же и мессия в нашей конфессии.
          </div>
          <div>
